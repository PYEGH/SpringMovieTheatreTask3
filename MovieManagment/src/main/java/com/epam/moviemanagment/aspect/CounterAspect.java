...
public class CounterAspect {
	...
	public void countNumberOfGettingEventByName(JoinPoint joinPoint,
		...
		// DB counters increasing
		this.counterDao.increaseCounterValue("eventByNameCounter", eventName);
	...
	public void countNumberTicketPriceCalling(JoinPoint joinPoint,
		...
		// DB counters increasing
		this.counterDao.increaseCounterValue("counterTicket", eventName);
		logger.info("Counter for "
				+ joinPoint.getTarget().getClass().getSimpleName() + " "
				+ joinPoint.getSignature().getName() + " works. Event: "
				+ eventName);
	...
	public void countNumberOfBookedTickets(JoinPoint joinPoint,
		...
		logger.info("ticketEntity" + ticketEntity.getEventEntity().getName());
		...
		// DB counters increasing
		this.counterDao.increaseCounterValue("eventPriceCounter", eventName);
